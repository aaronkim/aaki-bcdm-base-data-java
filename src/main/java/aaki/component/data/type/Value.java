 ...
 */
public class Value implements DataType, DataValue {
...
//    }
    ...
    public Value(final Class<?> _dataClass, final String _name, final Object _value) {
        mTypeObject = Value.convertTypeObject(_dataClass, _name, _value);
        mName = _name;
    }

    public Value(final Class<?> _dataClass, final String _name) {
        this(_dataClass, _name, null);
    }

    public Value(final String _name, final Integer _value) {
        this(Integer.class, _name, _value);
    }

    public Value(final String _name, final Long _value) {
        this(Long.class, _name, _value);
    }

    public Value(final String _name, final Short _value) {
        this(Short.class, _name, _value);
    }

    public Value(final String _name, final Double _value) {
        this(Double.class, _name, _value);
    }

    public Value(final String _name, final Float _value) {
        this(Float.class, _name, _value);
    }

    public Value(final String _name, final Boolean _value) {
        this(Boolean.class, _name, _value);
    }

    public Value(final String _name, final String _value) {
        this(String.class, _name, _value);
    }

    public Value(final Value _value) {
    ...
    private static DataTypeImplement convertTypeObject(final Class<?> _dataClass, final String _name, final Object _value) {
        ...
        if (Integer.class.isAssignableFrom(clazz)) {
           ...
           return (_value == null) ? new ValueInteger(_name) : new ValueInteger(_name, (Integer)_value);
            ...
            return new ValueObject<Object>(Object.class, _name);

        }
    }

    protected final DataTypeImplement getTypeObject() {
        return mTypeObject == null ? Value.convertTypeObject(Object.class, mName, null) : mTypeObject;
    }

    protected void setTypeObject(DataTypeImplement _typeObject) {
        if (_typeObject == null) {
            mTypeObject = Value.convertTypeObject(Object.class, mName, null);
        } else {
    ...
    public void setData(final Object _data) {
        mTypeObject = Value.convertTypeObject(_data.getClass(), getName(), _data);
