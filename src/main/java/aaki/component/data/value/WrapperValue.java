 ...
 */
class WrapperValue implements DataType, DataValue {
...
//    }
    ...
    public WrapperValue(final Class<?> _dataClass, final String _name, final Object _value) {
        mTypeObject = WrapperValue.convertTypeObject(_dataClass, _name, _value);
        mName = _name;
    }

    public WrapperValue(final Class<?> _dataClass, final String _name) {
        this(_dataClass, _name, null);
    }

    public WrapperValue(final String _name, final Integer _value) {
        this(Integer.class, _name, _value);
    }

    public WrapperValue(final String _name, final Long _value) {
        this(Long.class, _name, _value);
    }

    public WrapperValue(final String _name, final Short _value) {
        this(Short.class, _name, _value);
    }

    public WrapperValue(final String _name, final Double _value) {
        this(Double.class, _name, _value);
    }

    public WrapperValue(final String _name, final Float _value) {
        this(Float.class, _name, _value);
    }

    public WrapperValue(final String _name, final Boolean _value) {
        this(Boolean.class, _name, _value);
    }

    public WrapperValue(final String _name, final String _value) {
        this(String.class, _name, _value);
    }

    public WrapperValue(final WrapperValue _value) {
    ...
    protected final DataTypeImplement getTypeObject() {
        return mTypeObject == null ? WrapperValue.convertTypeObject(Object.class, mName, null) : mTypeObject;
    }

    protected void setTypeObject(DataTypeImplement _typeObject) {
        if (_typeObject == null) {
            mTypeObject = WrapperValue.convertTypeObject(Object.class, mName, null);
        } else {
            mTypeObject = _typeObject;
        }
    }

    public void setValue(WrapperValue _value) {
        if (_value == null) {
            mTypeObject = WrapperValue.convertTypeObject(Object.class, mName, null);
        } else {
            mTypeObject = _value.getTypeObject();
    ...
    public void setData(final Object _data) {
        mTypeObject = WrapperValue.convertTypeObject(_data.getClass(), getName(), _data);
